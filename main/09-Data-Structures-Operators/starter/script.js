...
console.log(maskCreditCard(64637835));
console.log(maskCreditCard(43378463864647384));
console.log(maskCreditCard('24645786116456485646657'));
...
const rest = new Map();
rest.set('name', 'Classoico Italiano');
rest.set(1, 'Firenze, Italy');
console.log(rest.set(2, 'Lisbon, Portugal'));

rest.set('catigories', ['Italian', 'Pizzeria', 'Vegetarian', 'Organic'])
  .set('open', 11)
  .set('close', 23)
